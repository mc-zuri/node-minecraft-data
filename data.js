module.exports =
{
  'pc': {
    ...
    '1.21.10': {
      get attributes () { return require("./minecraft-data/data/pc/1.21.10/attributes.json") },
      get blockCollisionShapes () { return require("./minecraft-data/data/pc/1.21.10/blockCollisionShapes.json") },
      get blocks () { return require("./minecraft-data/data/pc/1.21.10/blocks.json") },
      get blockLoot () { return require("./minecraft-data/data/pc/1.20/blockLoot.json") },
      get biomes () { return require("./minecraft-data/data/pc/1.21.10/biomes.json") },
      get commands () { return require("./minecraft-data/data/pc/1.20.3/commands.json") },
      get effects () { return require("./minecraft-data/data/pc/1.21.10/effects.json") },
      get enchantments () { return require("./minecraft-data/data/pc/1.21.10/enchantments.json") },
      get entities () { return require("./minecraft-data/data/pc/1.21.10/entities.json") },
      get entityLoot () { return require("./minecraft-data/data/pc/1.20/entityLoot.json") },
      get foods () { return require("./minecraft-data/data/pc/1.21.10/foods.json") },
      get instruments () { return require("./minecraft-data/data/pc/1.21.10/instruments.json") },
      get items () { return require("./minecraft-data/data/pc/1.21.10/items.json") },
      get language () { return require("./minecraft-data/data/pc/1.21.10/language.json") },
      get loginPacket () { return require("./minecraft-data/data/pc/1.21.3/loginPacket.json") },
      get mapIcons () { return require("./minecraft-data/data/pc/1.20.2/mapIcons.json") },
      get materials () { return require("./minecraft-data/data/pc/1.21.10/materials.json") },
      get particles () { return require("./minecraft-data/data/pc/1.21.10/particles.json") },
      get protocol () { return require("./minecraft-data/data/pc/1.21.10/protocol.json") },
      get recipes () { return require("./minecraft-data/data/pc/1.21.10/recipes.json") },
      get sounds () { return require("./minecraft-data/data/pc/1.21.10/sounds.json") },
      get tints () { return require("./minecraft-data/data/pc/1.21.10/tints.json") },
      get version () { return require("./minecraft-data/data/pc/1.21.10/version.json") },
      get windows () { return require("./minecraft-data/data/pc/1.16.1/windows.json") },
      proto: __dirname + '/minecraft-data/data/pc/1.21.10/proto.yml'
    },
    '1.21.11': {
  ...
  'bedrock': {
    ...
    '1.21.130': {
      ...
      types: __dirname + '/minecraft-data/data/bedrock/1.21.130/types.yml',
