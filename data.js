module.exports =
{
  ...
  'bedrock': {
    ...
    '1.26.10': {
      ...
      get windows () { return require("./minecraft-data/data/bedrock/1.16.201/windows.json") },
      get steve () { return require("./minecraft-data/data/bedrock/1.21.70/steve.json") },
      get blocksB2J () { return require("./minecraft-data/data/bedrock/1.26.10/blocksB2J.json") },
      get blocksJ2B () { return require("./minecraft-data/data/bedrock/1.26.10/blocksJ2B.json") },
